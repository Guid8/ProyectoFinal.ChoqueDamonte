...
from AppCoder.views import canchaGolf, instalaciones, nosotros, inicio, socioFormulario, busquedaSocios, buscar, leerSocios, eliminarSocio, editarSocio, sociosList, sociosDetalle, sociosCreacion, sociosUpdate, sociosDelete, login_request, register, editarPerfil, agregarAvatar
