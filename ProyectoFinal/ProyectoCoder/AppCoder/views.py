...
def editarSocio(request, nombre_socio):
    ...
    if request.method=="POST":
        ...
        form= SociosForm(initial={"nombre":socios.nombre, "apellido":socios.apellido, "email":socios.email, "actividad":socios.actividad})
    return render(request, "AppCoder/editarSocio.html", {"formulario":form, "nombre_socio":nombre_socio})
